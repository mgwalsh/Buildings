# Tanzania 250m resolution building distribution map data setup 
# M. Walsh, April 2018
...
download("https://www.dropbox.com/s/cr6wlwb71uf5t38/TZ_cropland_2018.csv.zip?raw=1", "TZ_cropland_2018.csv.zip", mode = "wb")
unzip("TZ_cropland_2018.csv.zip", overwrite = T)
geos <- read.table("TZ_cropland_2018.csv", header = T, sep = ",")
...
# download Gtifs and stack in raster
